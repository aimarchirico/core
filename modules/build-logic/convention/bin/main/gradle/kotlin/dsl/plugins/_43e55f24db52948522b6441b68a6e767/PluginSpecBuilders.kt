...
package gradle.kotlin.dsl.plugins._43e55f24db52948522b6441b68a6e767
...
/**
 * The `com.ncorti` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComNcortiPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.ncorti`.
 */
internal
val `ComPluginGroup`.`ncorti`: `ComNcortiPluginGroup`
    get() = `ComNcortiPluginGroup`(plugins)


/**
 * The `com.ncorti.ktfmt` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComNcortiKtfmtPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.ncorti.ktfmt`.
 */
internal
val `ComNcortiPluginGroup`.`ktfmt`: `ComNcortiKtfmtPluginGroup`
    get() = `ComNcortiKtfmtPluginGroup`(plugins)


/**
 * The `com.ncorti.ktfmt.gradle` plugin implemented by [com.ncorti.ktfmt.gradle.KtfmtPlugin].
 */
internal
val `ComNcortiKtfmtPluginGroup`.`gradle`: PluginDependencySpec
    get() = plugins.id("com.ncorti.ktfmt.gradle")
