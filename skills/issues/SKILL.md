...
1. Preflight: Verify that `CONTRIBUTING.md` exists in the repository root and the `.github/ISSUE_TEMPLATE/` directory exists. If any are missing, run `npx @aimarchirico/core-conventions` to materialize the documentation.
